                                ...
                                <div class="progress">
                                    <div class="progress-bar progress-bar-megna" role="progressbar" aria-valuenow="${inProgressPercent}"
                                        aria-valuemin="0" aria-valuemax="100" style="width: ${inProgressPercent}%"> <span
                                            class="sr-only">${inProgressPercent}% Complete (success)</span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="white-box">
                        <div class="col-in row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="progress">
                                    <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="${donePercent}"
                                        aria-valuemin="0" aria-valuemax="100" style="width: ${donePercent}%"> <span
                                            class="sr-only">${donePercent}% Complete (success)</span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
